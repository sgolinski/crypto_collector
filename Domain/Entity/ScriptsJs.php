...
class ScriptsJs
{
    ...
    public const CONTENT_SELECTOR_TABLE_BODY_XPATH_FILTERED = '//*[@id="content"]/div[2]/div/div[2]/div[2]/table/tbody/tr/td[6][contains(text(), "WBNB")] | td[6][contains(text(), "BUSD")] ';
...
//*[@id="content"]/div[2]/div/div[2]/div[2]/table/tbody/tr[1]/td[5]/text()